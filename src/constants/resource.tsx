  ...
  },
  {
    ...
    rows: [
      row(
        ...
        'Commvault',
        1402,
        ['Agentless VM 백업 지원', 'KVM 호스트 기반으로 가상머신 디스크 백업 수행', 'Full / Incremental 백업 지원'],
        ['백업 실행 제어 주체 : Mold', '백업 저장/관리 주체 : Commvault', '지원 버전 : Commvault 11.32.89'],
      ),
      row(
        'backup-dell-networker',
        'Dell Networker',
        1403,
        ['Agentless VM 백업 지원', 'KVM 호스트에서 외부 디스크 스냅샷 기반 가상머신 디스크 백업 수행', 'Full 백업 지원'],
        ['백업 실행 제어 주체 : Mold', '백업 저장/관리 주체 : NetWorker', '지원 버전 : NetWorker REST API v3 지원 버전'],
      ),
      row(
        'backup-veeam',
        'Veeam',
        1404,
        ['Agentless VM 백업 지원', 'KVM 호스트 기반으로 가상머신 디스크 백업 수행', 'Full / Incremental 백업 지원'],
        ['백업 실행 제어 주체 : Veeam', '백업 저장/관리 주체 : Veeam', '지원 버전 : Veeam Backup & Replication 13.0.1'],
      ),
      row(
        'backup-veritas',
        'Veritas NetBackup',
        1405,
        ['Agentless VM 백업 지원', 'KVM 호스트 기반으로 가상머신 디스크 백업 수행', 'Full / Incremental 백업 지원'],
        ['백업 실행 제어 주체 : NetBackup', '백업 저장/관리 주체 : NetBackup', '지원 버전 : NetBackup 10.5, 11.1'],
      ),
