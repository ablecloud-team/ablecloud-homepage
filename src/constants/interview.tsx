  ...
  return [
    {
      ...
      data: [
        ...
        { img: <Image src={busanoceanSrc} alt='' width={100} />, text: '부산방해양수산청' },
        ...
        { img: <Image src={andongSrc} alt='' width={170} />, text: '안동' },
        { img: <Image src={donghaeSrc} alt='' width={170} />, text: '동해' },
        ...
        { img: <Image src={chuncheonSrc} alt='' width={170} />, text: '춘천' },
        { img: <Image src={yangsSrc} alt='' width={170} />, text: '양산' },
        { img: <Image src={geojeSrc} alt='' width={170} />, text: '거제' },
        { img: <Image src={gongjuSrc} alt='' width={170} />, text: '공주' },
        { img: <Image src={sachanSrc} alt='' width={170} />, text: '사천' },
        { img: <Image src={billyangSrc} alt='' width={170} />, text: '밀양' },
        ...
        { img: <Image src={taeanSrc} alt='' width={170} />, text: '태안' },
        { img: <Image src={ulsanSrc} alt='' width={193} />, text: '울산광역시중구' },
        { img: <Image src={daeguSouthSrc} alt='' width={130} />, text: '대구남구' },
        { img: <Image src={incheonWestSrc} alt='' width={170} />, text: '인천서구' },
        { img: <Image src={busanCentralSrc} alt='' width={170} />, text: '부산중구' },
        ...
        { img: <Image src={koreaOceanSrc} alt='' width={170} />, text: '해양수산' },
        { img: <Image src={yeosuGwangyangSrc} alt='' width={170} />, text: '여수광양한만공사' },
        { img: <Image src={pohangTechSrc} alt='' width={170} />, text: '포항테크노파크' },
      ],
    },
    {
      ...
      data: [
        ...
        { img: <Image src={rokTrainSrc} alt='' width={170} />, text: 'ROK-TRAIN' },
      ],
    },
    {
      ...
      data: [
        ...
        { img: <Image src={hanpassSrc} alt='' width={170} />, text: '한패스' },
        { img: <Image src={ezlSrc} alt='' width={170} />, text: 'EZL' },
      ],
    },
    {
      ...
      data: [
        ...
        { img: <Image src={konyangSrc} alt='' width={168} />, text: '건양대학교' },
        { img: <Image src={yitSrc} alt='' width={136} />, text: '여주대학교' },
        { img: <Image src={busanUniversitySrc} alt='' width={170} />, text: '부산대학교' },
        ...
        { img: <Image src={gyeognamInfoSrc} alt='' width={170} />, text: '경남정보대학교' },
      ],
    },
    {
      category: t('category.4'),
      data: [
        { img: <Image src={poscoSrc} alt='' width={170} />, text: '포스코' },
        ...
        { img: <Image src={dongwonSrc} alt='' width={170} />, text: '동원금속주식회사' },
